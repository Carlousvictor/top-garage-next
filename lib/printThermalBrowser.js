...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .name { font-size: 14px; font-weight: 800; letter-spacing: .3px; margin-bottom: 1mm; }
  .small { font-size: 9px; line-height: 1.25; }
  .title { font-weight: 700; margin: 1.5mm 0; }
  ...
  .row.total { font-size: 13px; font-weight: 800; margin-top: 1mm; }
  .obs { font-size: 10px; word-break: break-word; }
