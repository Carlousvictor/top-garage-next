...
export default function SignupPage() {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            // 2. Create Company
            // Assuming 'companies' table has 'name' column and autogenerated 'id'
                    ...
                    <div className="-space-y-px rounded-md shadow-sm">
                        ...
                        <div>
                            <input
                                type="email"
                                required
                                className="relative block w-full border-0 bg-neutral-800 py-2 px-3 text-white ring-1 ring-inset ring-neutral-700 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6"
                                placeholder="Email"
                                value={email}
